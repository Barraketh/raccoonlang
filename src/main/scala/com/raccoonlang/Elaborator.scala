...
object Elaborator {
  ...
  private def elabCase(c: SA.Case, env: ResolveEnv): CA.Case = {
    ...
    CA.Case(c.ctorName, c.argNames, argRefs, elabTerm(c.body, bodyEnv), c.span)
  }
