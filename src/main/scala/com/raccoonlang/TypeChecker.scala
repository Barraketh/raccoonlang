...
object TypeChecker {
  private final case class CheckedPi(vpi: VPi, bodyEnv: TypecheckEnv, outTy: Value)
  ...
  private def checkSelect(baseValue: Value, field: String, span: Span, env: TypecheckEnv)(implicit
      eqStore: EqStore
  ): Value = {
