...
This suite complements the historical nested dependent benchmark. The scenarios stress conversion,
local contexts, dependent match refinement, projection, universe levels, and transparent evaluation. Lean files are generated for the same
